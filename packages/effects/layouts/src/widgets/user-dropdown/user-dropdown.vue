...
interface Props {
  ...
  hoverDelay?: number;
  /** 菜单内容类名 */
  menuContentClass?: any;
  /** 菜单触发器类名 */
  menuTriggerClass?: any;
}
...
<template>
  ...
  <DropdownMenu v-model:open="openPopover">
    <DropdownMenuTrigger ref="refTrigger" :disabled="props.trigger === 'hover'">
      <div
        class="hover:bg-accent ml-1 mr-2 cursor-pointer rounded-full p-1.5"
    ...
    <DropdownMenuContent class="mr-2 min-w-[240px] p-0 pb-1" :class="menuContentClass">
      <div ref="refContent">
