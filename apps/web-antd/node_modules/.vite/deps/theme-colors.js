...
// ../../node_modules/.pnpm/theme-colors@0.1.0/node_modules/theme-colors/dist/index.mjs
...
var withTint = (intensity) => (hex) => tint(hex, intensity);
var withShade = (intensity) => (hex) => shade(hex, intensity);
var _variants = {
  50: withTint(0.95),
  100: withTint(0.9),
  200: withTint(0.75),
