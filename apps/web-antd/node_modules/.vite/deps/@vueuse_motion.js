import {
  defu
} from "./chunk-6TBIZJQI.js";
import {
  unrefElement,
  useEventListener,
  useIntersectionObserver,
  useMediaQuery
} from "./chunk-XVBPS3FX.js";
import {
  isObject,
  tryOnUnmounted
} from "./chunk-6IVJNBRK.js";
...
// ../../node_modules/.pnpm/@vueuse+motion@3.0.3_magicast@0.3.5_vue@3.5.13_typescript@5.8.3_/node_modules/@vueuse/motion/dist/index.mjs
var motionState = {};
...
var MotionValue = class {
  ...
  constructor(init) {
     ...
     */
    __publicField(this, "scheduleVelocityCheck", () => es_default.postRender(this.velocityCheck));
    /**
...
function useMotionControls(motionProperties, variants = {}, { motionValues, push, stop } = useMotionTransitions()) {
  ...
  const apply = (variant) => {
    ...
    async function waitForComplete() {
      ...
      (_b = (_a2 = variant.transition) == null ? void 0 : _a2.onComplete) == null ? void 0 : _b.call(_a2);
    }
...
var supportsPointerEvents = () => {
  var _a2;
  return isBrowser && (window.onpointerdown === null || ((_a2 = import.meta.env) == null ? void 0 : _a2.TEST));
};
var supportsTouchEvents = () => {
  var _a2;
  return isBrowser && (window.ontouchstart === null || ((_a2 = import.meta.env) == null ? void 0 : _a2.TEST));
};
var supportsMouseEvents = () => {
  var _a2;
  return isBrowser && (window.onmousedown === null || ((_a2 = import.meta.env) == null ? void 0 : _a2.TEST));
};
...
var CUSTOM_PRESETS = Symbol(
  ((_a = import.meta.env) == null ? void 0 : _a.MODE) === "development" ? "motionCustomPresets" : ""
);
...
function setupMotionComponent(props) {
  ...
  if (((_a2 = import.meta.env) == null ? void 0 : _a2.MODE) === "development") {
    ...
    const replayAnimation = (instance) => {
      var _a3;
      if ((_a3 = instance.variants) == null ? void 0 : _a3.initial) {
        instance.set("initial");
      }
      nextTick(() => {
        var _a4, _b, _c;
        if ((_a4 = instance.variants) == null ? void 0 : _a4.enter)
  ...
  function setNodeInstance(node, index, style) {
    ...
    (_a3 = node.props).style ?? (_a3.style = {});
...
var MotionGroupComponent = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      var _a2;
      const style = variantToStyle(motionConfig.value.initial || {});
      const nodes = ((_a2 = slots.default) == null ? void 0 : _a2.call(slots)) || [];
  ...
  install(app, options) {
    ...
    if (options && options.directives) {
      for (const key in options.directives) {
        ...
        if (!variants.initial && ((_a2 = import.meta.env) == null ? void 0 : _a2.MODE) === "development") {
          console.warn(
