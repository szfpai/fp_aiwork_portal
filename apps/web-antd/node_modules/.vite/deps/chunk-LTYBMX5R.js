...
// ../../node_modules/.pnpm/vxe-pc-ui@4.5.35_vue@3.5.13_typescript@5.8.3_/node_modules/vxe-pc-ui/es/tooltip/src/tooltip.js
...
var tooltip_default = defineComponent({
  ...
  setup(props, context) {
    ...
    const handleDelayFn = () => {
      internalData.showDelayTip = import_xe_utils.default.debounce(() => {
        if (reactData.tipActive) {
          showTip();
        }
    ...
    const handleVisible = (target, content) => {
      ...
      if (!contentSlot && (content === "" || import_xe_utils.default.eqNull(content))) {
        return nextTick();
      }
      if (target) {
    ...
    const getSelectorEl = () => {
      ...
      if (selector) {
        if (import_xe_utils.default.isElement(selector)) {
          return selector;
        }
        if (import_xe_utils.default.isString(selector)) {
    ...
    const renderVN = () => {
      ...
      return h("div", Object.assign({ ref: refElem, class: ["vxe-tooltip--wrapper", `theme--${theme}`, popupClassName ? import_xe_utils.default.isFunction(popupClassName) ? popupClassName({ $tooltip: $xeTooltip }) : popupClassName : "", {
        [`size--${vSize}`]: vSize,
      ...
      nextTick(() => {
        ...
        if (wrapperElem) {
          ...
          if (parentNode) {
            reactData.tipContent = content;
            reactData.tipZindex = nextZIndex();
            import_xe_utils.default.arrayEach(wrapperElem.children, (elem, index) => {
              if (index > 1) {
...
//# sourceMappingURL=chunk-LTYBMX5R.js.map
