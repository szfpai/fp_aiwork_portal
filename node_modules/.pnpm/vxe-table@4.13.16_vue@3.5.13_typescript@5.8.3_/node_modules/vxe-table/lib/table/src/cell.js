...
function renderCellHandle(params) {
  ...
  if ((0, _utils.isEnableConf)(editConfig) && editRender) {
...
const Cell = exports.Cell = {
  ...
  renderSeqCell(params) {
    ...
    return renderCellBaseVNs(params, [(0, _vue.h)('span', `${(0, _utils.formatText)(seqMethod ? seqMethod(params) : treeConfig ? seq : (seqOpts.startIndex || 0) + seq, 1)}`)]);
  },
  ...
  renderEditHeader(params) {
    ...
    if ((0, _utils.isEnableConf)(editConfig)) {
      editIconVNs = [isRequired && editOpts.showAsterisk ? (0, _vue.h)('i', {
        class: 'vxe-cell--required-icon'
      }) : renderEmptyElement($table), (0, _utils.isEnableConf)(editRender) && editOpts.showIcon ? (0, _vue.h)('i', {
