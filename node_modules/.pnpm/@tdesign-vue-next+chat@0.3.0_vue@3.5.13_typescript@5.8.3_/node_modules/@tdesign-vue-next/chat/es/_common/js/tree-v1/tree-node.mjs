...
import { uniqueId, isNil, get, isNumber, isFunction, isBoolean, isNull } from 'lodash-es';
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    _defineProperty(this, "isIndeterminateManual", void 0);
...
export { TreeNode, TreeNode as default, privateKey, settableProps, settableStatus, syncableProps };
