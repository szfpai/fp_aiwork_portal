...
export declare type ChatGlobalConfigProvider = GlobalConfigProvider & {
    chat: {
        placeholder: string;
        stopBtnText: string;
...
export declare type Locale = typeof defaultZhLocale;
export declare const configProviderInjectKey: InjectionKey<ComputedRef<ChatGlobalConfigProvider>>;
export declare const mergeWith: (defaultGlobalConfig: ChatGlobalConfigProvider, injectConfig: ChatGlobalConfigProvider) => GlobalConfigProvider & {
    chat: {
        placeholder: string;
        stopBtnText: string;
        refreshTipText: string;
