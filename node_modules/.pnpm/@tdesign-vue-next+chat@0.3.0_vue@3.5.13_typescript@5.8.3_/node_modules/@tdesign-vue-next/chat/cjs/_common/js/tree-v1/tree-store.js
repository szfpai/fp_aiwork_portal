...
var mitt = require('../../../_chunks/dep-92bf00f3.js');
...
require('../../../_chunks/dep-b0dea4c8.js');
require('../../../_chunks/dep-34a0bc88.js');
require('../../../_chunks/dep-ec4e7644.js');
  ...
  return _createClass__default["default"](TreeStore, [{
    ...
    value: function getNodes(item, options) {
      ...
      if (options) {
        ...
        if (omit.isPlainObject(conf.props)) {
          nodes = nodes.filter(function (node) {
    ...
    value: function appendNodes(para, item) {
      ...
      if (spec.data) {
        if (!spec.node) {
          ...
          } else if (isArray.isArray(spec.data)) {
    ...
    value: function replaceExpanded(list) {
      ...
      var added = mitt.difference(list, expanded);
      var removed = mitt.difference(expanded, list);
    ...
    value: function emit(name, state) {
      ...
      var methodName = mitt.camelCase("on-".concat(name));
