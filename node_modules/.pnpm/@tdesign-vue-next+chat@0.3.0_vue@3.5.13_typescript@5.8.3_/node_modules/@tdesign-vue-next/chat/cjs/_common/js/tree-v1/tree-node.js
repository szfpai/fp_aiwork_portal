...
var isNumber = require('../../../_chunks/dep-170a4ce0.js');
var get = require('../../../_chunks/dep-b0dea4c8.js');
var isFunction = require('../../../_chunks/dep-5e9cd92c.js');
var omit = require('../../../_chunks/dep-79961a41.js');
var isNull = require('../../../_chunks/dep-34a0bc88.js');
var uniqueId = require('../../../_chunks/dep-ec4e7644.js');
require('../../../_chunks/dep-f7715a9f.js');
...
require('../../../_chunks/dep-4dc04a42.js');
require('../../../_chunks/dep-4fc10188.js');
require('../../../_chunks/dep-9414c8ef.js');
require('../../../_chunks/dep-a7810102.js');
require('../../../_chunks/dep-cf20ea45.js');
require('../../../_chunks/dep-11c17bd0.js');
require('../../../_chunks/dep-4b062c61.js');
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    _defineProperty__default["default"](this, "isIndeterminateManual", void 0);
    ...
    this.draggable = null;
    this[privateKey] = uniqueId.uniqueId(prefix);
    this.value = uniqueId.isNil(get.get(data, propValue)) ? this[privateKey] : get.get(data, propValue);
    ...
    this.label = get.get(data, propLabel) || "";
    this.disabled = get.get(data, propsDisabled);
  ...
  return _createClass__default["default"](TreeNode, [{
    ...
    value: function initExpanded() {
      ...
      var config = tree.config;
      if (isNumber.isNumber(config.expandLevel) && this.getLevel() < config.expandLevel) {
      ...
      var _loadChildren = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        ...
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              config = get.get(this, "tree.config") || {};
              if (!(this.children === true && !this.loading)) {
                _context.next = 13;
                break;
              }
              if (!("load" in config && isFunction.isFunction(config.load))) {
                _context.next = 13;
                break;
              }
              this.loading = true;
    ...
    value: function getChildren(deep) {
      ...
      } else if (omit.isBoolean(children)) {
    ...
    value: function isDraggable() {
      var state = !!get.get(this, "tree.config.draggable");
    ...
    value: function isExpandMutex() {
      var state = !!get.get(this, "tree.config.expandMutex");
    ...
    value: function isActivable() {
      var state = !!get.get(this, "tree.config.activable");
    ...
    value: function isCheckable() {
      var state = !!get.get(this, "tree.config.checkable");
