...
var _baseGet = require('../../../_chunks/dep-f7715a9f.js');
var _baseSet = require('../../../_chunks/dep-9414c8ef.js');
...
require('../../../_chunks/dep-5e9cd92c.js');
...
function hasPath(object, path, hasFunc) {
  ...
  return !!length && _baseSlice.isLength(length) && _isIndex.isIndex(key, length) && (isArray.isArray(object) || omit.isArguments(object));
}
