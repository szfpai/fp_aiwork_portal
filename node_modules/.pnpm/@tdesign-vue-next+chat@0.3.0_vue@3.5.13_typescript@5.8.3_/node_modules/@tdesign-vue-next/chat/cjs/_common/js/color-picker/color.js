...
var Color = /*#__PURE__*/function () {
  ...
  return _createClass__default["default"](Color, [{
    ...
    value: function getFormattedColor(format, enableAlpha) {
      ...
      var finalFormat = enableAlpha && format in _common_js_colorPicker_constants.ALPHA_FORMAT_MAP ? _common_js_colorPicker_constants.ALPHA_FORMAT_MAP[format] : format;
...
_defineProperty__default["default"](Color, "compare", function (color1, color2) {
  ...
  if (isGradientColor1 && isGradientColor2) {
    var gradientStr1 = _common_js_colorPicker_gradient.parseGradientString(color1);
    var gradientStr2 = _common_js_colorPicker_gradient.parseGradientString(color2);
