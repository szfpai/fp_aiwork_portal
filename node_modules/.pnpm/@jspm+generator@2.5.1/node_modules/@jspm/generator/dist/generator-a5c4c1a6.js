...
function configureProviders(providerConfig, providers) {
...
class Resolver {
    ...
    constructor({ env, log, fetchOpts, preserveSymlinks = false, traceCjs = true, traceTs = true, traceSystem = true }){
        _define_property$4(this, "log", void 0);
        ...
        _define_property$4(this, "providers", defaultProviders);
...
async function getAnalysis(resolver, resolvedUrl) {
    ...
    const source = await _fetch.arrayBuffer(resolvedUrl, resolver.fetchOpts);
 ...
 */ class Generator {
   ...
   */ constructor({ baseUrl: baseUrl$1, mapUrl, rootUrl = undefined, inputMap = undefined, env = [
        ...
        if (process$1 === null || process$1 === void 0 ? void 0 : (_process_env = process$1.env) === null || _process_env === void 0 ? void 0 : _process_env.JSPM_GENERATOR_LOG) {
            (async ()=>{
        ...
        if (typeof preserveSymlinks !== "boolean") preserveSymlinks = typeof (process$1 === null || process$1 === void 0 ? void 0 : (_process_versions = process$1.versions) === null || _process_versions === void 0 ? void 0 : _process_versions.node) === "string";
...
export { Generator as G, setBabel$1 as a, setBabel as b, analyzeHtml as c, setFetch as d, clearCache as e, fetch as f, getPackageConfig as g, getPackageBase as h, getDefaultProviders as i, lookup as l, parseUrlPkg as p, setPathFns as s };
