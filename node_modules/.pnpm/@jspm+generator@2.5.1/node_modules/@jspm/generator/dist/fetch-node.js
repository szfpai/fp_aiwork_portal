import { w as wrappedFetch } from './fetch-common-3aa262c0.js';
...
function clearCache() {
    rmdirSync(path.join(cacheDir, "fetch-cache"), {
        recursive: true
    });
}
...
const fetch = wrappedFetch(async function(url, opts) {
    ...
    switch(protocol){
        ...
        case "data:":
            return sourceResponse(decodeURIComponent(urlString.slice(urlString.indexOf(",") + 1)));
        case "node:":
