...
declare const _default: {
    ...
    readonly calendar: {
        ...
        readonly week: "Monday,Tuesday,Wedsday,Thuresday,Friday,Saturday,Sunday";
    ...
    readonly transfer: {
        ...
        readonly empty: "Empty Data";
        readonly placeholder: "enter keyword to search";
    };
    readonly timePicker: {
    ...
    readonly form: {
        readonly errorMessage: {
            ...
            readonly whitespace: "${name} cannot be empty";
    ...
    readonly typography: {
        readonly expandText: "more";
        readonly collapseText: "collapse";
        readonly copiedText: "copied";
    };
    readonly rate: {
        readonly rateText: readonly ["terrible", "disappointed", "normal", "satisfied", "surprised"];
    };
    readonly empty: {
        readonly titleText: {
            readonly maintenance: "Under Construction";
    ...
    readonly chat: {
        readonly placeholder: "please enter message...";
        readonly stopBtnText: "stop";
        readonly refreshTipText: "regenerate";
        readonly copyTipText: "copy";
        readonly likeTipText: "like";
        readonly dislikeTipText: "dislike";
        readonly copyCodeBtnText: "copy code";
        readonly copyCodeSuccessText: "copied";
        readonly clearHistoryBtnText: "clear history";
        readonly copyTextSuccess: "copied";
        readonly copyTextFail: "copy failed";
        readonly confirmClearHistory: "Are you sure to clear all messages?";
    };
};
