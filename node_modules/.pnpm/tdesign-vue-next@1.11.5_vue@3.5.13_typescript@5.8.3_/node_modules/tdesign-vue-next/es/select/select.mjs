...
import { get, isArray, isFunction, cloneDeep, intersection, debounce, pick } from 'lodash-es';
...
import { getSingleContent, getMultipleContent } from './utils/index.mjs';
...
var _Select = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var handleSearch = debounce(function (value2, _ref5) {
    ...
    return function () {
      var _ref7 = props2.popupProps || {},
        ...
        restPopupProps = _objectWithoutProperties(_ref7, _excluded);
