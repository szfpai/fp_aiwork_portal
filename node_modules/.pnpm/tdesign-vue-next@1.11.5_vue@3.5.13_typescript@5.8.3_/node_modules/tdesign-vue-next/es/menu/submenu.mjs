...
import { defineComponent, getCurrentInstance, inject, toRefs, computed, ref, provide, reactive, nextTick, createVNode, mergeProps, Transition, withDirectives, vShow, watch, onMounted } from 'vue';
...
import { u as useTNodeJSX, a as useContent } from '../_chunks/dep-46ec3e86.mjs';
...
var _Submenu = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var renderPopup = function renderPopup(triggerElement) {
      ...
      var realPopup = createVNode(Popup, mergeProps((_props2$popupProps3 = props2.popupProps) !== null && _props2$popupProps3 !== void 0 ? _props2$popupProps3 : {}, {
