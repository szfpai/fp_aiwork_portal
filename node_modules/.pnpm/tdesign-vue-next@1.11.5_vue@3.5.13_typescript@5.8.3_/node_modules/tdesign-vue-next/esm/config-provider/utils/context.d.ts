...
import defaultZhLocale from 'tdesign-vue-next/esm/common/js/global-config/locale/zh_CN';
...
export declare const defaultGlobalConfig: {
    ...
    readonly animation: Record<"include" | "exclude", Array<import("tdesign-vue-next/esm/common/js/global-config/default-config").AnimationType>>;
    readonly attach: any;
    readonly calendar: {
