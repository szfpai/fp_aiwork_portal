import { TypeCreateElement, TypeTreeOptionData } from './adapt';
...
declare const _default: import("vue").DefineComponent<{
    ...
    rebuild: (list: import("./tree-types").TreeProps["data"]) => void;
    updateStoreConfig: () => void;
    setActived: (item: import("./tree-types").TypeTargetNode, isActived: boolean) => import("@common/js/tree/types").TreeNodeValue[];
    ...
    renderTreeNodes: (h: TypeCreateElement) => import("./adapt").TypeVNode[];
