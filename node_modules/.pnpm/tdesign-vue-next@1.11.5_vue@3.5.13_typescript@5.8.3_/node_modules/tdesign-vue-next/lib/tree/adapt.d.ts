...
import { TypeTreeEventState as TreeEventState } from 'tdesign-vue-next/lib/common/js/tree/types';
...
export { TreeNode, privateKey } from 'tdesign-vue-next/lib/common/js/tree/tree-node';
...
export declare function useVModel(props: TreeProps & Record<string, any>, refsProps: ToRefs<TreeProps> & Record<string, any>, propName?: string, defaultPropName?: string, eventPropName?: string, eventName?: string): [Vue.Ref<any>, import("../hooks").ChangeHandler<any, any[]>];
