...
var getDayCn = function getDayCn(num) {
  ...
  if (numStr in calendar_consts_index.DAY_CN_MAP) {
    re = calendar_consts_index.DAY_CN_MAP[numStr];
  }
  return re;
};
...
var createYearCellsData = function createYearCellsData(props, state) {
  ...
  for (var num = calendar_consts_index.FIRST_MONTH_OF_YEAR; num <= calendar_consts_index.LAST_MONTH_OF_YEAR; num++) {
    _loop(num);
  }
  return monthsArr;
};
