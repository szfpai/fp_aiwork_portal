...
import { TypeTreeEventState as TreeEventState } from 'tdesign-vue-next/cjs/common/js/tree/types';
...
export { TreeNode, privateKey } from 'tdesign-vue-next/cjs/common/js/tree/tree-node';
