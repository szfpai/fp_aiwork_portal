...
var utils = require('../../_chunks/dep-f025d925.js');
...
function useUpload(props) {
  ...
  var _useConfig = configProvider_hooks_useConfig.useConfig("upload"),
  ...
  var locale = Vue.computed(function () {
    return configProvider_utils_context.merge({}, globalConfig.value, props.locale);
  });
  ...
  var onFileChange = function onFileChange(files2) {
    ...
    var params = {
      currentSelectedFiles: formatToUploadFile(_toConsumableArray__default["default"](files2), props.format)
    };
