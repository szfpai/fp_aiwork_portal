...
var _commonjsHelpers = require('../../_chunks/dep-30fb1b25.js');
...
function isValueEmpty(val) {
  ...
  return isObject.isObject(val) ? isEmpty.isEmpty(val) : ["", void 0, null].includes(val);
}
var VALIDATE_MAP = {
  date: isDate,
  url: isURL,
  ...
  "boolean": function boolean(val) {
    return isBoolean.isBoolean(val);
  },
  max: function max(val, num) {
    return isNumber.isNumber(val) ? val <= num : helper.getCharacterLength(val) <= num;
  },
  min: function min(val, num) {
    return isNumber.isNumber(val) ? val >= num : helper.getCharacterLength(val) >= num;
  },
  len: function len(val, num) {
    return helper.getCharacterLength(String(val)) === num;
  },
  number: function number(val) {
    return isNumber.isNumber(val);
  },
    ...
    return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 18:
          ...
          if (!isBoolean.isBoolean(validateResult)) {
            _context.next = 21;
            break;
          }
        ...
        case 21:
          if (!isObject.isObject(validateResult)) {
            _context.next = 23;
            break;
          }
          return _context.abrupt("return", validateResult);
