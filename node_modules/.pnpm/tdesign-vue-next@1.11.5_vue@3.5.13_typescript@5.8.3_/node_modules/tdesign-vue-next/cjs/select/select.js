...
var intersection = require('../_chunks/dep-0b6921ca.js');
...
var _Select = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var setInnerValue = function setInnerValue(newVal, context) {
      if (props2.valueType === "object") {
        ...
        var getOption = function getOption(val) {
          ...
          return _defineProperty__default["default"](_defineProperty__default["default"]({}, value2, get.get(option, value2)), label, get.get(option, label));
        };
    ...
    var placeholderText = Vue.computed(function () {
      var _ref3;
      return (_ref3 = !props2.multiple && innerPopupVisible.value && select_utils_index.getSingleContent(innerValue.value, optionsMap) || props2.placeholder) !== null && _ref3 !== void 0 ? _ref3 : t(globalConfig.value.placeholder);
    });
    var displayText = Vue.computed(function () {
      return props2.multiple ? select_utils_index.getMultipleContent(innerValue.value, optionsMap) : select_utils_index.getSingleContent(innerValue.value, optionsMap);
    });
    var valueDisplayParams = Vue.computed(function () {
      var val = props2.multiple && isArray.isArray(innerValue.value) ? innerValue.value.map(function (value2) {
    ...
    return function () {
      var _ref7 = props2.popupProps || {},
        overlayClassName = _ref7.overlayClassName,
        restPopupProps = _objectWithoutProperties__default["default"](_ref7, _excluded);
      return Vue.createVNode("div", {
        ...
        panel: function panel() {
          return Vue.createVNode(select_selectPanel["default"], Vue.mergeProps({
            "ref": selectPanelRef
          }, pick.pick(props2, ["size", "multiple", "empty", "loading", "loadingText", "filterable", "creatable", "panelTopContent", "panelBottomContent", "filter", "scroll"]), {
