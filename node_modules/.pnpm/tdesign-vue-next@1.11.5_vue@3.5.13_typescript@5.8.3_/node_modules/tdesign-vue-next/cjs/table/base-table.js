...
var _BaseTable = Vue.defineComponent({
  ...
  render: function render() {
    ...
    }, pick.pick(this.$props, table_tbody.extendTableProps)), {}, {
    ...
    }), this.$slots), Vue.createVNode(table_tbody["default"], Vue.mergeProps({
      "ref": "tableBodyRef"
    }, tableBodyProps), this.$slots), Vue.createVNode(table_tfoot["default"], {
      "rowKey": this.rowKey,
      "isFixedHeader": this.isFixedHeader,
      "rowAndColFixedPosition": rowAndColFixedPosition,
    ...
    var getCustomLoadingText = isFunction.isFunction(this.loading) ? this.loading : this.$slots.loading;
