...
var isArrayLikeObject = require('../../_chunks/dep-feae46a3.js');
var _baseDifference = require('../../_chunks/dep-9780143c.js');
var _flatRest = require('../../_chunks/dep-43bc982b.js');
var _cacheHas = require('../../_chunks/dep-62aae11c.js');
var _arrayIncludesWith = require('../../_chunks/dep-732925e8.js');
var _Set = require('../../_chunks/dep-9de7d250.js');
var _setToArray = require('../../_chunks/dep-7c08b9a8.js');
var last = require('../../_chunks/dep-beb9de0a.js');
...
function baseXor(arrays, iteratee, comparator) {
  ...
  return baseUniq(_flatRest.baseFlatten(result, 1), iteratee, comparator);
}
...
function useFixed(props, context, finalColumns, affixRef) {
  ...
  var onResize = debounce.debounce(function () {
    refreshTable();
  }, 30);
  var resizeObserver = null;
  function addTableResizeObserver(tableElement) {
    if (typeof window === "undefined") return;
    if (helper.getIEVersion() < 11 || typeof window.ResizeObserver === "undefined") return;
