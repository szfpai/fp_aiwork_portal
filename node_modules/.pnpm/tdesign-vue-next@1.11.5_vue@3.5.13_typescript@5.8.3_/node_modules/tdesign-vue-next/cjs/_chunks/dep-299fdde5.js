...
var log = require('./dep-cef23b69.js');
var isBoolean = require('./dep-82a90f9f.js');
var omit = require('./dep-d67d6b6f.js');
var get = require('./dep-56c837c8.js');
var isUndefined = require('./dep-93cf0a54.js');
var isNumber = require('./dep-cea0dc9b.js');
var isFunction = require('./dep-047617bf.js');
var isNull = require('./dep-8afe2bf0.js');
var toString = require('./dep-e495f218.js');
var isNil = require('./dep-22f8eb15.js');
...
function uniqueId(prefix) {
  var id = ++idCounter;
  return toString.toString(prefix) + id;
}
...
var TreeNodeModel = /*#__PURE__*/function () {
  ...
  return _createClass__default["default"](TreeNodeModel, [{
    ...
    value: function remove(value) {
      ...
      if (!targetNode) {
        log.log.warnOnce("Tree", "`".concat(value, "` is not exist"));
        return;
      }
      ...
      if (parentValues.indexOf(node.value) < 0) {
        log.log.warnOnce("Tree", "`".concat(value, "` is not a childNode of current node"));
        return;
      }
      targetNode.remove();
    }
...
var TreeNode = /*#__PURE__*/function () {
  function TreeNode(tree, data, parent) {
    ...
    this.value = isNil.isNil(get.get(data, propValue)) ? this[privateKey] : get.get(data, propValue);
    var nodeMap = tree.nodeMap,
      privateMap = tree.privateMap;
    if (nodeMap.get(this.value)) {
      log.log.warn("Tree", "Dulplicate value: ".concat(this.value));
    }
    nodeMap.set(this.value, this);
    privateMap.set(this[privateKey], this);
    this.label = get.get(data, propLabel) || "";
    this.disabled = get.get(data, propDisabled) || false;
        ...
        return _regeneratorRuntime__default["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (!isFunction.isFunction(config.load)) {
                _context.next = 13;
                break;
              }
              this.loading = true;
...
//# sourceMappingURL=dep-299fdde5.js.map
