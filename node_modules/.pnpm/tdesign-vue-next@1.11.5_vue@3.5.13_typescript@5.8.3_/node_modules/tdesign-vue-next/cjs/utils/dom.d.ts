...
import { EasingFunction } from 'tdesign-vue-next/cjs/common/js/utils/easing';
...
export declare const clickOut: (els: VNode | Element | Iterable<any> | ArrayLike<any>, cb: () => void) => void;
export declare const isTextEllipsis: (ele: ComponentPublicInstance | Element | ComponentPublicInstance[] | Element[]) => boolean;
